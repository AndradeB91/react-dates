...
storiesOf("DateRangePicker (DRP)", module)
  .add("default", withInfo()(() => <DateRangePickerWrapper />))
  .add("hidden with display: none", withInfo()(() => <TestWrapper />))
  .add(
    "as part of a form",
    withInfo()(() => (
      <div>
  ...
  .add(
    "with navigation disabled for minDate and maxDate",
    withInfo()(() => {
      const minDate = moment();
      const maxDate = moment().add(2, "month");
      return <DateRangePickerWrapper maxDate={maxDate} minDate={minDate} />;
    })
  );
